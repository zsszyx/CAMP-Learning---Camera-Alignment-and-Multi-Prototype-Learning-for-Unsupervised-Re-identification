...
def compute_jaccard_distance(target_features, k1=20, k2=6, print_flag=True, search_option=4, use_float16=False):
    end = time.time()
    if print_flag:
    ...
    # nn_k1 = k_reciprocal_neigh(initial_rank, k1)
    # nn_k1_half = k_reciprocal_neigh(initial_rank, int(np.around(k1/2)))
